        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde los entornos rurales, las prácticas de crianza se configuran como expresiones vivas de cultura, afecto y tradición, que moldean el desarrollo de la niñez campesina. Esta unidad explora las pautas, estilos y valores transmitidos en el contexto familiar rural, reconociendo los retos y fortalezas propios de estas dinámicas. Se abordarán temas claves como el rol de la familia, el apego, los medios de vida y las condiciones socioculturales que influyen en la protección y el bienestar de las infancias rurales, promoviendo una mirada integral, reflexiva y respetuosa de sus derechos y realidades.
              
              p #[b ¡Explore cómo la crianza en lo rural transforma vidas y fortalece comunidades!]
